...
# Sélectionne une image aléatoire dans le dossier
img_list = list(Path("TP1/data/images").glob("*.jpg"))
if not img_list:
	raise FileNotFoundError("Aucune image .jpg trouvée dans TP1/data/images")
