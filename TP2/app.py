...
prompt = st.text_area("Prompt", value="ultra-realistic product photo of a pair of red nike shoes on a white background, studio lighting, soft shadow, very sharp")
