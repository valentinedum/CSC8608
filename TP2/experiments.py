...
def run_text2img_experiments() -> None:
    ...
    seed = 42
    prompt = "ultra-realistic product photo of a backpack on a white background, studio lighting, soft shadow, very sharp"  # e-commerce prompt
...
def run_img2img_experiments() -> None:
    ...
    init_path = "inputs/nike.jpg"  # ex: "my_product.jpg"

    prompt = "ultra-realistic product photo of a pair of red nike shoes on a white background, studio lighting, soft shadow, very sharp"  # e-commerce prompt
    negative = "text, watermark, logo, low quality, blurry, deformed"
